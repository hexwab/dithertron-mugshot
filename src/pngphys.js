/* via https://github.com/murkle/rewrite-png-pHYs-chunk */
...
window.rewrite_pHYs_chunk = function (data, ppmx, ppmy, unit) {
...
// Uint8Arrays.
  ...
  while (idx < data.length) {
	...
	if (name == "IDAT") {
		...
		phys[i++] = data2[chunkDataStart++] = uint8[1];
		phys[i++] = data2[chunkDataStart++] = uint8[0];
		// unit: 0=undefined, 1=meters
		phys[i++] = data[chunkDataStart++] = unit;
